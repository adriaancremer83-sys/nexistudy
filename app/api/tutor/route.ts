...
function buildSystem(ctx: {
  ...
  return [
    ...
    "",
    "How you help:",
    `- Reply in ${ctx.language}. If you are not fully fluent in ${ctx.language}, reply in clear English and give key terms in ${ctx.language} — never write broken ${ctx.language}.`,
